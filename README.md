# Sanic-ChatGPT3.5-linebot-Render
# 一個使用Sanic框架和GPT3.5 turbo模型官方API，創造一個linebot，快速建置於平台Render。
...
### [English](https://github.com/pyfbsdk59/Sanic-GPT3.5-linebot-Render/blob/main/README_en.md)
### [日本語](https://github.com/pyfbsdk59/Sanic-GPT3.5-linebot-Render/blob/main/README_jp.md)
